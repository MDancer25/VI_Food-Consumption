AmCharts.translations.export || (AmCharts.translations.export = {}), AmCharts.translations.export.en || (AmCharts.translations.export.en = {
    ...
    AmCharts.export = function(a, b) {
        var c,
            d = {
                    ...
                    handler: {
                        ...
                        change: function(a, b, c) {
                            ...
                            if (e.mode && (d.drawing.mode = e.mode), e.width && (d.drawing.width = e.width, d.drawing.fontSize = 3 * e.width), e.fontSize && (d.drawing.fontSize = e.fontSize), e.color && (d.drawing.color = e.color), e.opacity && (d.drawing.opacity = e.opacity), h = d.getRGBA(d.drawing.color), h.pop(), h.push(d.drawing.opacity), d.drawing.color = "rgba(" + h.join() + ")", d.setup.fabric.freeDrawingBrush.color = d.drawing.color, d.setup.fabric.freeDrawingBrush.width = d.drawing.width, i) {
                                for (f = JSON.parse(i.recentState).cfg, f && (e.color = e.color || f.color, e.width = e.width || f.width, e.opacity = e.opacity || f.opacity, e.fontSize = e.fontSize || 3 * e.width, h = d.getRGBA(e.color), h.pop(), h.push(e.opacity), e.color = "rgba(" + h.join() + ")"), g = 0; g < j.length; g++)
                                    j[g] instanceof fabric.Text || j[g] instanceof fabric.PathGroup || j[g] instanceof fabric.Triangle ? ((e.color || e.opacity) && j[g].set({
                                        fill: e.color
                                    }), e.fontSize && j[g].set({
                                        fontSize: e.fontSize
                    ...
                    if (d.libs.autoLoad)
                        for (a = 0; a < d.libs.resources.length; a++)
                            if (d.libs.resources[a] instanceof Object)
                                ...
                                d.loadResource(d.libs.resources[a])
                },
                ...
                cloneObject: function(a) {
                    ...
                    b = Array.isArray(a) ? [] : {};
                    for (e in a)
                        c = a[e], f = "object" == typeof c, g = c instanceof Date, b[e] = f && !g ? d.cloneObject(c) : c;
                    return b
                },
                ...
                removeImage: function(a) {
                    if (a) {
                        if (d.config.fabric.forceRemoveImages)
                            return !0;
                        if (d.config.fabric.removeImages && d.isTainted(a))
                            return !0;
                        if (d.setup.isIE && (10 == d.setup.IEversion || 11 == d.setup.IEversion) && a.toLowerCase().indexOf(".svg") != -1)
                            return !0
                    }
                    return !1
                },
                isTainted: function(a) {
                    ...
                    if (a) {
                        if (b.indexOf(":\\") != -1 || a.indexOf(":\\") != -1 || b.indexOf("file://") != -1 || a.indexOf("file://") != -1)
                            return !0;
                ...
                gatherClassName: function(a, b, c, e) {
                    var f,
                        ...
                        c = c ? c : 3;
                    if (d.isElement(a)) {
                        if (f = (a.getAttribute("class") || "").split(" ").indexOf(b) != -1, !f && e < c)
                    ...
                    for (e = 0; e < a.children.length; e++) {
                        ...
                        if ("clipPath" == g.tagName) {
                            ...
                            for (f = 0; f < g.childNodes.length; f++)
                                g.childNodes[f].setAttribute("fill", "transparent"), h = {
                            ...
                            c.included++, fabric.Image.fromURL(g.getAttribute("xlink:href"), function(a) {
                                c.loaded++
                            });
                        else {
                            var k = ["fill", "stroke"];
                ...
                modifyFabric: function() {
                    fabric.ElementsParser.prototype.resolveGradient = function(a, b) {
                        ...
                        if (/^url\(/.test(c)) {
                            ...
                            if (fabric.gradientDefs[this.svgUid][d]) {
                                var e = fabric.Gradient.fromElement(fabric.gradientDefs[this.svgUid][d], a);
                                e.coords.y1 && (e.coords.y2 = e.coords.y1 * -1, e.coords.y1 = 0), a.set(b, e)
                            }
                        }
                        ...
                        if ("textContent" in a)
                            ...
                            "firstChild" in a && null !== a.firstChild && "data" in a.firstChild && null !== a.firstChild.data && e.push(a.firstChild.data);
                        d = e.join("\n");
                    ...
                    if (d.config.legend) {
                        if ("stock" == d.setup.chart.type)
                            for (c = 0; c < d.setup.chart.panels.length; c++)
                                d.setup.chart.panels[c].stockLegend && d.setup.chart.panels[c].stockLegend.divId && i.items.push(d.setup.chart.panels[c].stockLegend);
                        else
                            d.setup.chart.legend && d.setup.chart.legend.divId && i.items.push(d.setup.chart.legend);
                    ...
                    for (d.setup.canvas = document.createElement("canvas"), d.setup.wrapper.appendChild(d.setup.canvas), d.setup.fabric = new fabric.Canvas(d.setup.canvas, d.deepMerge({
                        ...
                        if (d.isPressed(a.e), d.drawing.buffer.isPressed && !d.drawing.buffer.isSelected && (d.drawing.buffer.isDrawing = !0, !d.drawing.buffer.line && "pencil" != d.drawing.mode && (b.xD > 5 || b.yD > 5) && (d.setup.fabric.isDrawingMode = !1, d.setup.fabric._isCurrentlyDrawing = !1, d.setup.fabric.freeDrawingBrush.onMouseUp(), d.setup.fabric.remove(d.setup.fabric._objects.pop()), d.drawing.buffer.line = d.drawing.handler.line({
                            ...
                            for (h.x2 = b.x2, h.y2 = b.y2, c = 0; c < h.group.length; c++)
                                e = h.group[c], e instanceof fabric.Line ? e.set({
                                    x2: h.x2,
                                    y2: h.y2
                        ...
                        if (!d.drawing.buffer.isDrawing || d.drawing.buffer.hasLine)
                            return d.setup.fabric.remove(b), void d.setup.fabric.renderAll()
                                ...
                                for (a.offset.absolute ? (void 0 !== a.offset.bottom ? n.top = g.height - a.offset.height - a.offset.bottom : n.top = a.offset.top, void 0 !== a.offset.right ? n.left = g.width - a.offset.width - a.offset.right : n.left = a.offset.left) : (n.top = a.offset.y, n.left = a.offset.x), j = 0; j < l.paths.length; j++) {
                                    ...
                                    if (l.paths[j]) {
                                        ...
                                        if (l.paths[j].fill instanceof Object)
                                            "radial" == l.paths[j].fill.type && ["pie", "gauge"].indexOf(d.setup.chart.type) == -1 && (l.paths[j].fill.coords.r2 = l.paths[j].fill.coords.r1 * -1, l.paths[j].fill.coords.r1 = 0, l.paths[j].set({
                ...
                toSVG: function(a, b) {
                    var c = [],
                        ...
                        g = d.setup.fabric.toSVG(f, f.reviver);
                    if (c.length) {
                ...
                toPRINT: function(a, b) {
                    ...
                    for (f.setAttribute("style", "width: 100%; max-height: 100%;"), c = 0; c < h.length; c++)
                        d.isElement(h[c]) && (g[c] = h[c].style.display, h[c].style.display = "none");
                ...
                toByteArray: function(a, b) {
                    ...
                    function m(a) {
                        ...
                        for (b = 0, c = 0; b < d; b += 4, c += 3)
                            f = l(a.charAt(b)) << 18 | l(a.charAt(b + 1)) << 12 | l(a.charAt(b + 2)) << 6 | l(a.charAt(b + 3)), k((16711680 & f) >> 16), k((65280 & f) >> 8), k(255 & f);
                ...
                handleDropbox: function(a) {
                    if (d.drawing.enabled)
                        if (a.preventDefault(), a.stopPropagation(), "dragover" == a.type)
                            d.setup.wrapper.setAttribute("class", d.setup.chart.classNamePrefix + "-export-canvas active dropbox");
                ...
                getChartData: function(a) {
                    ...
                    if (0 == b.data.length)
                        if ("stock" == d.setup.chart.type) {
                                ...
                                for (f = 0; f < d.setup.chart.panels.length; f++) {
                                    ...
                                    for (g = 0; g < l.stockGraphs.length; g++) {
                                        ...
                                        for (i4 = 0; i4 < h.length; i4++)
                                            m[h[i4]] == k.toField && j(k.fromField, m.title, h[i4])
                                    }
                                }
                            }
                            ...
                            for (e = 0; e < d.setup.chart.dataProvider.length; e++) {
                                ...
                                if (r[q])
                                    for (f = 0; f < r[q].length; f++)
                                        r[q][f][d.setup.chart.categoryField] = r[d.setup.chart.categoryField], b.data.push(r[q][f])
                            }
                            ...
                            b.data = d.setup.chart.dataProvider, j(d.setup.chart.titleField), b.dateFields.push(d.setup.chart.titleField), j(d.setup.chart.valueField);
                ...
                processData: function(b) {
                    ...
                    if (c.data.length) {
                        for (e = 0; e < c.data.length; e++)
                            for (f in c.data[e])
                                c.dataFields.indexOf(f) == -1 && (c.dataFields.push(f), c.dataFieldsMap[f] = f);
                    ...
                    function g(b, c) {
                        ...
                        for (e = 0; e < b.length; e++) {
                            ...
                            if (j.format = String(j.format).toUpperCase(), d.config.formats[j.format] ? j = d.deepMerge({
                                ...
                                if ("draw" == j.action)
                                    d.config.fabric.drawing.enabled ? (j.menu = j.menu ? j.menu : d.config.fabric.drawing.menu, j.click = function(a) {
                                        return function() {
                                    ...
                                    j.click || j.menu || j.items || (d.drawing.handler[o] instanceof Function ? (j.action = o, j.click = function(a) {
                                        return function() {
        ...
        if (b)
            d.config = b;
        else if (d.setup.chart[d.name])
            d.config = d.setup.chart[d.name];
        else {
