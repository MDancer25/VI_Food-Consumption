        ...
        for (var c in a) {
            ...
            if (0 < a[c].length && "object" == e)
                for (var f = 0; f < a[c].length; f++)
                    e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c][f], e);
            else
            ...
            for (a = b.length - 1; 0 <= a; a--) {
                ...
                if (f <= e) {
                    ...
                    if ("translate" == h) {
                        ...
                        l = Number(c.from), k = Number(c.to), m = k - l, c = d[c.effect](0, f, l, m, e), isNaN(c) && (c = k), 0 === m && this.animations.splice(a, 1);
                    this.setAttr(g, h, c)
                } else
                    "translate" == h ? (l = c.to.split(","), m = Number(l[0]), l = Number(l[1]), g.translate(m, l)) : (k = Number(c.to), this.setAttr(g, h, k)), g.animationFinished = !0, this.animations.splice(a, 1)
            }
        },
        getBBox: function(a) {
            if (a = a.node)
    ...
    d.AmChart = d.Class({
        ...
        drawBackground: function() {
            ...
            if (b = this.backgroundImage)
                a = a.image(b, 0, 0, f, g), d.setCN(this, b, "bg-image"), this.bgImg = a, e.push(a)
        },
            ...
            if (this.animations)
                for (a = this.animations.length - 1; 0 <= a; a--) {
                    ...
                    if (e <= c) {
                        ...
                        f.node.style[g] = Number(b.to) + b.suffix, f.animationFinished = !0, this.animations.splice(a, 1)
                }
        },
        update: function() {
...
(function() {
    ...
    d.polygon = function(a, b, c, e, f, g, h, k, l, m, n) {
        ...
        for (var t = 1; t < b.length; t++)
            m && (b[t] = d.roundTo(b[t], 5), c[t] = d.roundTo(c[t], 5)), k += " L" + (h(b[t]) + n) + "," + (h(c[t]) + g);
        a = a.path(k + " Z").attr(f);
    ...
    d.bullet = function(a, b, c, e, f, g, h, k, l, m, n, q, r) {
        ...
        case "square":
            t = d.polygon(a, [-c /
            2, c / 2, c / 2, -c / 2], [c / 2, c / 2, -c / 2, -c / 2], e, f, g, h, k, m - 180, void 0, r);
            break;
        case "rectangle":
    ...
    d.line = function(a, b, c, e, f, g, h, k, l, m, n) {
        ...
        for (k = 1; k < b.length; k++)
            b[k] = d.roundTo(b[k], 5), c[k] = d.roundTo(c[k], 5), h += " L" + (e(b[k]) + m) + "," + (e(c[k]) + f);
        if (d.VML)
    ...
    d.handDrawnLine = function(a, b, c, e, f, g, h, k, l, m) {
        ...
        for (n = 1; n < b.length; n++)
            for (var r = [b[n - 1], b[n]], t = [c[n - 1], c[n]], t = d.makeHD(r, t, a.handDrawScatter), r = t[0], t = t[1], p = 1; p < r.length; p++)
                q.push(d.line(a, [r[p - 1], r[p]], [t[p - 1], t[p]], e, f, g + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0));
        return q
    };
    d.doNothing =
    function(a) {
    ...
    d.wedge = function(a, b, c, e, f, g, h, k, l, m, n, q, r, t) {
        ...
        e = a.set();
        var G;
        B && (u = p(10 * u), A = p(10 * A), x = p(10 * x), F = p(10 * F), v = p(10 * v), C = p(10 * C), z = p(10 * z), w = p(10 * w), b = p(10 * b), l = p(10 * l), c = p(10 * c), g *= 10, h *= 10, k *= 10, y *= 10, 1 > Math.abs(f) && 1 >= Math.abs(x - A) && 1 >= Math.abs(z - C) && (G = !0));
        f = "";
        var D;
        ...
        B ? (G || (f = " A" + p(b - g) + "," + p(c - h) + "," + p(b + g) + "," + p(c + h) + "," + p(A) + "," + p(C) + "," + p(x) + "," + p(z)), h = " M" + p(u) + "," + p(v) + " L" + p(A) + "," + p(C) + f + " L" + p(F) + "," + p(w)) : h = " M" + u + "," + v + " L" + A + "," + C + (" A" + g + "," + h + ",0," + H + ",1," + x + "," + z) + " L" + F + "," + w;
...
(function() {
    ...
    d.AmLegend = d.Class({
        ...
        drawLegend: function() {
            ...
            this.titleWidth = 0;
            if (f = this.title)
                f = d.text(this.container, f, this.color, a.fontFamily, this.fontSize, "start", !0), d.setCN(a, f, "legend-title"), f.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a = f.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
        ...
        arrangeEntries: function() {
            ...
            for (v = 0; v < u.length; v++) {
                ...
                E + w.width > q && 0 < v && 0 !== A && (t++, E = A = 0, C = E + w.width + g + n, x = x + z + m, z = 0);
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                k = b.switchType;
                var u;
                k && "none" != k && 0 < r && ("x" == k ? (u = b.createX(), u.translate(r /
                2, r / 2)) : u = b.createV(), u.dItem = a, !0 !== a.hidden ? "x" == k ? u.hide() : u.show() : "x" != k && u.hide(), b.switchable || u.hide(), b.addListeners(u, a), a.legendSwitch = u, q.push(u), d.setCN(c, u, "legend-switch"));
                k = b.color;
                ...
                var w;
                g && (g = d.fixBrakes(g), a.legendTextReal = g, w = b.labelWidth, w = isNaN(w) ? d.text(b.container, g, k, c.fontFamily, l, "start") : d.wrappedText(b.container, g, k, c.fontFamily, l, "start", !1, w, 0), d.setCN(c, w, "legend-label"), w.translate(b.lx +
                t, b.ly), q.push(w), b.labelDx = t, c = w.getBBox().width, b.maxLabelWidth < c && (b.maxLabelWidth = c));
                b.entries[b.index] = q;
    ...
    d.AmMap = d.Class({
        ...
        initChart: function() {
            ...
            if (this.sizeChanged && d.hasSVG && this.chartCreated) {
                ...
                (d.AmMap.base.initChart.call(this), d.hasSVG) ? (this.dataChanged && (this.parseData(), this.dispatchDataUpdated = !0, this.dataChanged = !1, a = this.legend) && (a.position = "absolute", a.invalidateSize()), this.createDescriptionsDiv(), this.svgAreas = [], this.svgAreasById = {}, this.drawChart()) : (this.chartDiv.style.textAlign = "", this.chartDiv.setAttribute("class", "ammapAlert"), this.chartDiv.innerHTML = this.svgNotSupported, this.fire({
                    type: "failed",
                    chart: this
                }))
        },
        ...
        handleMouseMove: function(a) {
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if (a = b.mapContainer) {
                    ...
                    k = a.scale;
                    b.isDragging && (b.balloon.hide(0), b.positionChanged(), c = a.x + (f - c), e = a.y + (g - e), b.preventDragOut && (r = -r * k + m / 2 - b.diffY * b.mapScale * k, m = m / 2 - b.diffY * b.mapScale * k, c = d.fitToBounds(c, -q * k + n / 2, n / 2), e = d.fitToBounds(e, r, m)), isNaN(c) || isNaN(e) || (a.translate(c, e, k, !0), b.updateSmallMap()));
                    b.previuosMouseX = f;
                    b.previuosMouseY = g
                }
            }
        ...
        returnInitialColorReal: function(a) {
            ...
            if (b) {
                ...
                if (k = a.image)
                    k.setAttr("fill", c), k.setAttr("stroke", h), k.setAttr("stroke-width", g), k.setAttr("fill-opacity", e), k.setAttr("stroke-opacity", f);
                        ...
                        if (3 == g.nodeType || 4 == g.nodeType) {
                            ...
                            if (g.attributes && g.attributes.length)
                                for (m = 0; m < g.attributes.length; m++)
                                    q[g.attributes[m].name] = g.attributes[m].value;
        ...
        fixMapPosition: function() {
            ...
            b = this.coordinatesToXY(d.radiansToDegrees(f),
        ...
        xyToCoordinates: function(a, b, c, e, f) {
            ...
            if (g = c.invert) {
                ...
                g = this.coordinateToLongitude(a), b = this.coordinateToLatitude(b);
            return {
    ...
    d.ZoomControl = d.Class({
        ...
        init: function(a, b) {
            ...
            if (g) {
                ...
                F.push(D);
                for (G = 1; G < H; G++)
                    z = f + G * g, z = d.line(b, [1, E - 2], [z, z], c.gridColor, c.gridAlpha, 1), d.setCN(a, z, "zoom-grid"), D.push(z);
                ...
                z.init(b, f, f, k, l, m, n, q, r, t, w, v, A);
...
(function() {
    ...
    d.AreasProcessor = d.Class({
        ...
        process: function(a) {
            ...
            for (d =
            0; d < c; d++)
                f = a[d], isNaN(f.value) ? f.percents = void 0 : (f.percents = (f.value - k) / g * 100, k == h && (f.percents = 100));
            for (d = 0; d < c; d++)
                f = a[d], this.createArea(f);
            b.outlinesToFront()
        },
...
(function() {
    ...
    d.ImagesProcessor = d.Class({
        ...
        updateSizeAndPosition: function(a) {
            ...
            isNaN(e) || isNaN(f) ? isNaN(l) || isNaN(k) || (f = b.coordinatesToXY(k, l), e = f.x, f = f.y, isNaN(r) || (e = r), isNaN(t) || (f = t), a.fixedSize ? (r = a.positionScale, isNaN(r) ? r = 0 : (--r, r *= 1 - 2 * Math.abs(m - .5)), m = {
                image: c,
                scale: 1 + r,
                mapImage: a
                ...
                if (0 < v.length) {
                    ...
                    if ("none" != A) {
                        var I,
                            ...
                            N;
                        if ("end" == A || "both" == A)
                            u = v[v.length - 1], D = C[C.length - 1], 1 < v.length ?
                        ...
                        "both" == A && (r = d.polygon(x, t, k, m, q, 1, m, q, void 0, !0), z.push(r), r.translate(M, N, 1 / n, !0), isNaN(I) || r.rotate(I), d.setCN(c, p, "map-line-arrow"), void 0 != a.id && d.setCN(c, p, "map-line-arrow-" + a.id), a.fixedSize && f.push(r));
                        if ("start" == A || "both" == A)
                            r = v[0], N = C[0], 1 < v.length ? (u = v[1], M = C[1]) : (u = r, M = N), I = 180 * Math.atan((N -
        ...
        getCoordinates: function(a, b) {
            ...
            if (!isNaN(a)) {
                ...
                if (1 < this.longitudes.length) {
                    ...
                    1 < this.x.length && (c = this.x[b], f = this.x[b + 1], e = this.y[b], g = this.y[b + 1]);
        ...
        init: function(a, b) {
            if (this.enabled) {
                ...
                if (this.showAsGradient)
                    c = d.rect(b, this.width, this.height, [c, e], 1, this.borderThickness, this.borderColor, 1, 0, 0), d.setCN(a, c, "value-legend-gradient"), c.translate(0, h), g.push(c);
                else
                    for (l = this.width / f, m = 0; m < f; m++)
                        n = d.getColorFade(c, e, 1 * m / (f - 1)), n = d.rect(b, l, this.height, n, 1, this.borderThickness, this.borderColor, 1), d.setCN(a, n, "value-legend-color"), d.setCN(a, n, "value-legend-color-" + m), n.translate(l * m, h), g.push(n);
                e = c = 0;
                f = g.getBBox();
        ...
        addObjects: function(a, b) {
            ...
            if (a.images)
                for (f = 0; f < a.images.length; f++)
                    g = a.images[f], void 0 === g.showInList && (g.showInList = c.showImagesInList), this.addObject(g, d);
            if (a.lines)
                for (f = 0; f < a.lines.length; f++)
                    g = a.lines[f], void 0 === g.showInList && (g.showInList = c.showLinesInList), this.addObject(g, d);
